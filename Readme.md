...
# Parsing Script – ezegen1psm - Rev. A

This **Parsing** script is designed for the **ezegen1psm** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing – ezegen1psm Rev. A

Este script de **Parsing** está diseñado para el modelo **ezegen1psm** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
